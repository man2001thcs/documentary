...
export ORADATA_VOLUME=/home/thanagor/Documents/git-lab-2/DataGuard-docker/oradata
export DG_DIR=/home/thanagor/Documents/git-lab-2/DataGuard-docker
```
...
## Note for restart standby

Đô Chu, [11/6/25 9:16 AM]
ALTER SYSTEM SET log_archive_config='dg_config=(DG11,dg21)' SCOPE=BOTH;

ALTER SYSTEM SET log_archive_dest_2='service="dg21" ASYNC NOAFFIRM delay=0 optional compression=disable max_failure=0 reopen=300 db_unique_name="dg21" net_timeout=30 valid_for=(online_logfile,all_roles)' SCOPE=BOTH;

ALTER SYSTEM SET log_archive_dest_state_2='ENABLE' SCOPE=BOTH;

Đô Chu, [11/6/25 9:17 AM]
